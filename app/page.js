      ...
      <main className='bg-[#0A192F] pt-5'>
        <section className='px-10 md:px-20 lg:px-40 min-h-screen'>
          <motion.div 
            ...
            className='py-12'>
            <h2 className='text-center text-5xl py-2 text-[#64FFDA] font-medium md:text-9xl'>Hey, I am Amaan</h2>
          </motion.div>
          <div className='flex flex-wrap'>
            ...
            <motion.div 
              ...
              <div className='relative mt-30 mx-auto bg-gradient-to-b from-[#64FFDA] rounded-full w-80 h-80 overflow-hidden'>
          ...
          animate={{opacity: 1}}
          transition={{duration: 0.8}} 
          className='text-5xl gap-16 py-16 text-[#64FFDA] flex justify-center items-center'>
            <motion.ul
        ...
        <div class="flex items-center justify-center py-5">
          <hr class="w-64 h-1 my-8 bg-[#64FFDA]/20 border-0 rounded"></hr>
        </div>

        {/* Second page */} 
        <section className='px-10 md:px-20 lg:px-40'>
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className='px-5 l:px-10'>
            <h3 className='text-center text-5xl text-[#64FFDA] font-medium md:text-9xl pb-10'>About me</h3>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className='px-5 l:px-10'>
          <h3 className='text-center text-5xl text-[#64FFDA] font-medium md:text-9xl pb-10'>Work Experience</h3>
          
          <div className="relative container mx-auto px-6 flex flex-col space-y-8">
            {/* Vertical line */}
            <div className="absolute z-0 w-2 h-full bg-[#64FFDA] shadow-md inset-0 left-17 md:mx-auto md:left-0 md:right-0"></div>
            ...
            <motion.div initial={{ x: -100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} className="relative z-10">
              <div className="timeline-container md:flex md:justify-between items-center w-full md:odd:flex-row-reverse">
                ...
                <div className="absolute left-16 md:mx-auto md:left-0 md:right-0 flex items-center justify-center w-6 h-6 transform -translate-x-1/2 bg-[#64FFDA] rounded-full">
                  <div className="w-3 h-3 bg-[#0A192F] rounded-full"></div>
                </div>
                <div className="ml-24 md:w-5/12 md:ml-0 p-6 bg-[#112240] rounded-lg shadow-md border border-[#64FFDA]/20">
                  <h3 className="text-xl font-bold mb-2 text-[#64FFDA]">DevOps Engineer</h3>
            ...
            <motion.div initial={{ x: 100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} className="relative z-10">
              <div className="timeline-container md:flex md:justify-between items-center w-full">
                ...
                <div className="ml-24 md:w-5/12 md:ml-0 p-6 bg-[#112240] rounded-lg shadow-md border border-[#64FFDA]/20">
                  <h3 className="text-xl font-bold mb-2 text-[#64FFDA]">DevOps Engineer Intern</h3>
        ...
        <div class="flex items-center justify-center pt-20">
          ...
          <motion.div initial={{ opacity: 0 }} transition={{ duration: 1 }} whileInView={{ opacity: 1 }} className='p-10'>
            <h2 className='text-center text-5xl py-2 text-[#64FFDA] font-medium md:text-9xl'>Some</h2>
            <h2 className='text-3xl py-2 text-center text-[#64FFDA] font-medium md:text-3xl'>of my</h2>
            <h2 className='text-center text-5xl py-2 text-[#64FFDA] font-medium md:text-9xl'>projects</h2>
          </motion.div>
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.5 }} className='flex flex-wrap gap-10 mx-auto justify-center m:10'> 
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              <Image src={quizApp} alt='Question Mark' wdith={100} height={100} className='mx-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>Quiz Application</h3>
              <p className='py-2 text-gray-300'>
                A quiz application to test your knowledge of basic to advanced github commands.
              </p>
              <h4 className='py-4 text-[#64FFDA]'>Tools</h4>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center gap-5 md:gap-18 align-bottom'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://khana251.github.io/quiz-app/'>Demo</a>
                </motion.li>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/quiz-app'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              <Image src={pong} alt='Pong logo' wdith={100} height={100} className='mx-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>Pong Game Simulator</h3>
              <p className='py-2 text-gray-300'>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/pong'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              <Image src={minimalCountdownTimer} alt='Timer logo' wdith={100} height={100} className='mx-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>Minimal Countdown Timer</h3>
              <p className='py-2 text-gray-300'>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center gap-5 md:gap-18'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://khana251.github.io/Minimal-Countdown-Timer/'>Demo</a>
                </motion.li>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/Minimal-Countdown-Timer'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
            ...
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              ...
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>AutoFileSorter</h3>
              <p className='py-2 text-gray-300'>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center gap-20'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/AutoFileSorter'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              <Image src={discScheduling} alt='disc scheduling logo' wdith={100} height={100} className='mx-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>Disk Scheduling in C</h3>
              <p className='py-2 text-gray-300'>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center gap-20'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/Disk-Scheduling-in-C'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
            <div className='xl:w-1/4 bg-[#112240] text-center shadow-lg p-10 rounded-xl my-10 border border-[#64FFDA]/20'>
              <Image src={two048} alt='2048 logo' wdith={100} height={100} className='mx-auto'/>
              <h3 className='text-lg font-medium pt-8 pb-2 text-[#64FFDA]'>2048 Game</h3>
              <p className='py-2 text-gray-300'>
              ...
              <motion.ul className='px-4 py-4 flex flex-wrap justify-center gap-20'>
                <motion.li whileHover={{ scale: 1.2 }}>
                  <a className='bg-[#0A192F] px-4 py-2 text-[#64FFDA] rounded-md border border-[#64FFDA]' href='https://github.com/khana251/2048-game'>Code</a>
                </motion.li>
              </motion.ul>
            </div>
          </motion.div>
        ...
        {/* Footer */}
        <footer className="py-10 mt-20 border-t border-[#64FFDA]/10">
          <div className="text-center">
            <p className="text-[#64FFDA]/60 text-sm">
