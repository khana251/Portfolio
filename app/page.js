          ...
          <nav className='py-10 mb-12 flex justify-end'>
            <motion.ul 
              ...
              <motion.li whileHover={{ scale: 1.2 }}>
                <a className='bg-gradient-to-r from-yellow-100 to-yellow-50 text-black px-4 py-2 rounded-md ml-8' href='https://drive.google.com/file/d/1H9IFl5_gupZ1KhGNz_I-awgK707zrNze/view?usp=drive_link'>Resume</a>
                </motion.li>
            </motion.ul>
          </nav>
          <motion.div 
